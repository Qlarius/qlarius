defmodule Qlarius.Legacy.Recipient do
  use Ecto.Schema
  ...
  schema "recipients" do
    ...
    belongs_to :user, Qlarius.Legacy.User
    belongs_to :recipient_type, Qlarius.Legacy.RecipientType
    belongs_to :approved_by_user, Qlarius.Legacy.User, foreign_key: :approved_by_user_id
