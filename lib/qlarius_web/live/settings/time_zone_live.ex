defmodule QlariusWeb.Settings.TimeZoneLive do
  ...
  def render(assigns) do
    ~H"""
    <div id="timezone-settings-pwa-detect" phx-hook="HiPagePWADetect">
      <Layouts.mobile {assigns}>
        <div class="mx-auto max-w-2xl">
          ...
          <div class="mb-6">
            <h1 class="text-2xl font-bold text-base-content mb-2">Time Zone</h1>
            <p class="text-base-content/60">Set your time zone</p>
          </div>
  ...
  def mount(_params, _session, socket) do
    {:ok,
     socket
     |> assign(:title, "Time Zone")
     |> assign(:current_path, "/settings/time_zone")
     |> assign(:is_pwa, false)
