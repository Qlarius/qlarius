defmodule QlariusWeb.CoreComponents do
  ...
  # In Phx 1.8 CoreComponents this is a private function
  # but I'm making it public so it can be used in the existing (pre-1.8)
  # auth pages
  ...
  attr :multipart, :boolean, default: false, doc: "sets enctype to multipart/form-data for file uploads"
