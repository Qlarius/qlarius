  ...
  (function() {
    ...
    if (!currentScript || !currentScript.hasAttribute("nomodule") || !("onbeforeload" in currentScript)) {
      ...
      !function() {
        ...
        var s = u.prototype;
        var l;
        s.import = function(e2, n2) {
          var t2 = this;
          return Promise.resolve(t2.resolve(e2, n2)).then(function(e3) {
            var n3 = function e4(n4, t3, r2) {
              var o2 = n4[c][t3];
              if (o2)
                return o2;
              var u2 = [], s2 = /* @__PURE__ */ Object.create(null);
              i && Object.defineProperty(s2, i, { value: "Module" });
              var l2 = Promise.resolve().then(function() {
                return n4.instantiate(t3, r2);
              }).then(function(e5) {
                if (!e5)
                  throw Error("Module " + t3 + " did not instantiate");
                var r3 = e5[1](function(e6, n5) {
                  o2.h = true;
                  var t4 = false;
                  if ("object" != typeof e6)
                    e6 in s2 && s2[e6] === n5 || (s2[e6] = n5, t4 = true);
                  else
                    for (var n5 in e6) {
                      var r4 = e6[n5];
                      n5 in s2 && s2[n5] === r4 || (s2[n5] = r4, t4 = true);
                    }
                  if (t4)
                    for (var e6 = 0; e6 < u2.length; e6++)
                      u2[e6](s2);
                  return n5;
                }, 2 === e5[1].length ? { import: function(e6) {
                  return n4.import(e6, t3);
                }, meta: n4.createContext(t3) } : void 0);
                return o2.e = r3.execute || function() {
                }, [e5[0], r3.setters || []];
              });
              var f2 = l2.then(function(r3) {
                return Promise.all(r3[0].map(function(o3, i2) {
                  var c2 = r3[1][i2];
                  return Promise.resolve(n4.resolve(o3, t3)).then(function(r4) {
                    var o4 = e4(n4, r4, t3);
                    return Promise.resolve(o4.I).then(function() {
                      return c2 && (o4.i.push(c2), !o4.h && o4.I || c2(o4.n)), o4;
                    });
                  });
                })).then(function(e5) {
                  o2.d = e5;
              ...
              return f2.catch(function(e5) {
                o2.e = null, o2.er = e5;
              }), o2 = n4[c][t3] = { id: t3, i: u2, n: s2, I: l2, L: f2, h: false, d: void 0, e: void 0, er: void 0, E: void 0, C: void 0 };
            }(t2, e3);
            return n3.C || function(e4, n4) {
              return n4.C = function e5(n5, t3, r2) {
                if (!r2[t3.id])
                  return r2[t3.id] = true, Promise.resolve(t3.L).then(function() {
                    return Promise.all(t3.d.map(function(t4) {
                      return e5(n5, t4, r2);
                    }));
                  });
              }(e4, n4, {}).then(function() {
                return function e5(n5, t3, r2) {
                  if (r2[t3.id])
                    return;
                  if (r2[t3.id] = true, !t3.e) {
                    if (t3.er)
                      throw t3.er;
                    return t3.E ? t3.E : void 0;
                  }
                  var o2;
                  return t3.d.forEach(function(t4) {
                    {
                      var i3 = e5(n5, t4, r2);
                      i3 && (o2 = o2 || []).push(i3);
                    }
                  }), o2 ? Promise.all(o2).then(i2) : i2();
                  function i2() {
                    try {
                      var e6 = t3.e.call(f);
                      if (e6)
                        return e6 = e6.then(function() {
                          t3.C = t3.n, t3.E = null;
                        }), t3.E = t3.E || e6;
                      t3.C = t3.n;
                    } catch (e7) {
        ...
        }, s.createContext = function(e2) {
          return { url: e2 };
        }, s.register = function(e2, n2) {
          l = [e2, n2];
        }, s.getRegister = function() {
          var e2 = l;
          return l = void 0, e2;
        };
        var f = Object.freeze(/* @__PURE__ */ Object.create(null));
        n.System = n.System || new u();
        var d = s.register;
        s.register = function(e2, n2) {
          d.call(this, e2, n2);
        }, s.instantiate = function(e2, n2) {
          var t2 = this;
          return ".json" === e2.substr(-5) ? fetch(e2).then(function(e3) {
            return e3.text();
          }).then(function(e3) {
            return [[], function(n3) {
              return { execute: function() {
                n3("default", JSON.parse(e3));
              } };
            }];
          }) : new Promise(function(r2, o2) {
            var i2;
            function c2(n3) {
              n3.filename === e2 && (i2 = n3.error);
            }
            window.addEventListener("error", c2);
            var u2 = document.createElement("script");
            u2.charset = "utf-8", u2.async = true, u2.addEventListener("error", function() {
              window.removeEventListener("error", c2), o2(Error("Error loading " + e2 + (n2 ? " from " + n2 : "")));
            }), u2.addEventListener("load", function() {
              window.removeEventListener("error", c2), document.head.removeChild(u2), i2 ? o2(i2) : r2(t2.getRegister());
            }), u2.src = e2, document.head.appendChild(u2);
          });
        }, e && "function" == typeof importScripts && (s.instantiate = function(e2) {
          var n2 = this;
        ...
        }), s.resolve = function(e2, n2) {
          var o2 = function(e3, n3) {
            if (-1 !== e3.indexOf("\\") && (e3 = e3.replace(r2, "/")), "/" === e3[0] && "/" === e3[1])
              return n3.slice(0, n3.indexOf(":") + 1) + e3;
            if ("." === e3[0] && ("/" === e3[1] || "." === e3[1] && ("/" === e3[2] || 2 === e3.length && (e3 += "/")) || 1 === e3.length && (e3 += "/")) || "/" === e3[0]) {
              var t2 = n3.slice(0, n3.indexOf(":") + 1);
              var r2;
              if (r2 = "/" === n3[t2.length + 1] ? "file:" !== t2 ? (r2 = n3.slice(t2.length + 2)).slice(r2.indexOf("/") + 1) : n3.slice(8) : n3.slice(t2.length + ("/" === n3[t2.length])), "/" === e3[0])
                return n3.slice(0, n3.length - r2.length - 1) + e3;
              var o3 = r2.slice(0, r2.lastIndexOf("/") + 1) + e3, i2 = [];
              var c2 = -1;
              for (var e3 = 0; e3 < o3.length; e3++)
                -1 !== c2 ? "/" === o3[e3] && (i2.push(o3.slice(c2, e3 + 1)), c2 = -1) : "." === o3[e3] ? "." !== o3[e3 + 1] || "/" !== o3[e3 + 2] && e3 + 2 !== o3.length ? "/" === o3[e3 + 1] || e3 + 1 === o3.length ? e3 += 1 : c2 = e3 : (i2.pop(), e3 += 2) : c2 = e3;
              return -1 !== c2 && i2.push(o3.slice(c2)), n3.slice(0, n3.length - r2.length) + i2.join("");
            }
          }(e2, n2 || t);
          if (!o2) {
            if (-1 !== e2.indexOf(":"))
              return Promise.resolve(e2);
            throw Error('Cannot resolve "' + e2 + (n2 ? '" from ' + n2 : '"'));
          }
...
//# sourceMappingURL=/assets/ionicons.js.map
